...
> **Instance state**: controlled `Draft 0.17`. Sections 1–7 define the information and exchange
...
| Approvers | Product Decision Authority approved the exact predecessor Spec/Tech baseline on 17-09-2026; approval of this 0.17 successor data/integration update is `NOT-RUN` |
