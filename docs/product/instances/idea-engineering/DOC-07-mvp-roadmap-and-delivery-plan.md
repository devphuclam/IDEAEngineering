...
> **Instance state**: controlled `Draft 0.7`. This roadmap plans work and decision presentations. It
...
| Change History | 0.7: route the Linux-first `TECH-001@0.10` engineering recommendation and current DOC-05@0.17 candidate Tech update; schedule, 56 tasks, 756 hours and all decision/gate states unchanged; [IE-CHG-TECH-LINUX-001](registers/CHG-2026-09-13-linux-first-server-runtime-re-evaluation.md). 0.6: routed `TECH-001@0.9`; [IE-CHG-TECH-DEC-001](registers/CHG-2026-09-13-technology-decision-recommendation.md). Earlier history remains in the linked change records. |
...
|---|---|---|---|---|---|---|---|
| `IE-INC-FEATURE-001` | `IE-PROD-ROADMAP-001@0.7` | `Draft` | `0.1` | Principal Product Author | `PG1` / `PG2` on material scope change | DOC-01/02/03, coverage records, `FEATURE-001` | Feature decision, source pins and open-action disposition |
| `IE-INC-SPEC-001` | `IE-PROD-ROADMAP-001@0.7` | `Draft` | `0.1` | Principal Product Author | `PG2` / `PG3` on requirement change | DOC-03/04/06/08, `SPEC-001` | Spec decision, trace and V&V readiness |
| `IE-INC-TECH-001` | `IE-PROD-ROADMAP-001@0.7` | `Draft` | `0.1` | Principal Product Author | `PG3` / `PG4` on technology change | DOC-02/04/05/06/08, ADRs, `TECH-001` | Tech decision, architecture review and risk disposition |
| `IE-INC-READY-001` | `IE-PROD-ROADMAP-001@0.7` | `Draft` | `0.1` | Principal Product Author | `PG4` | Approved Feature/Spec/Tech baselines and supporting records | Bounded implementation plan, tests, migration/recovery and gate result |
...
`IE-KNW-TECH-DEC-001@0.2`/`TECH-001@0.10` recommendation is not a Product Decision Authority approval.
...
| Operational handoff | Deploy/update/rollback, account administration, monitored coordinated backup/restore and primary/backup operator assignment | Tech 0.10, current DOC-05/DOC-06, future OPS baseline | User may operate initially; system management/technical support approve install/deploy; long-term owner and backup unassigned | `BLOCKED` for rollout |
...
|---|---|---|
| Review current decision briefs | Project user; assistant prepares | Feature 0.12, Spec 0.14 and Tech 0.10 presented against their exact source set; no inherited `PASS` |
...
| `CHANGE` | [IE-CHG-ROADMAP-001](registers/CHG-2026-09-05-roadmap-task-integration.md), [IE-CHG-SOURCE-RECON-001](registers/CHG-2026-09-09-cross-document-reconciliation.md), [IE-CHG-TECH-DEC-001](registers/CHG-2026-09-13-technology-decision-recommendation.md), [IE-CHG-TECH-LINUX-001](registers/CHG-2026-09-13-linux-first-server-runtime-re-evaluation.md) and [Work Item](https://github.com/devphuclam/IDEAEngineering/issues/1) | Draft 0.7 changes current Tech/DOC-05 candidate routing only; schedule, approval and gate unchanged. Earlier reconciliations remain historical. |
