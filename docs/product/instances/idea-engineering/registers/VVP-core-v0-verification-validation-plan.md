...
> **Supporting-record state**: controlled `Draft 0.17`. This plan defines how the proposed Core v0
...
| Record Status | `Draft` |
| Record Version | `0.17` |
| Applicable Baseline / Effective Date | `IE-SPEC-CORE-V0-001@0.14` / `NOT APPLICABLE` until approval |
...
|---|---|---|
| Internal document review | Project user reviews the assistant-authored plan for completeness, clarity and product fit; author consistency checks remain separate. | Prior exact-version reviews and the predecessor PDA approval are retained. The project user selected the multi-location Vault direction on 17-09-2026; this is internal successor-design confirmation, not evidence that procedures passed or that VVP@0.17 received independent/qualified review. |
