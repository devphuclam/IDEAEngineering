...
[Mở gallery 30 view](../evidence/IE-VEV-ARCH-CORR-003/index.html) ·
[Kết quả render và source hash](../evidence/IE-VEV-ARCH-CORR-003/render-results.json) ·
[Kết quả mở SVG độc lập](../evidence/IE-VEV-ARCH-CORR-003/svg-open-results.json).
