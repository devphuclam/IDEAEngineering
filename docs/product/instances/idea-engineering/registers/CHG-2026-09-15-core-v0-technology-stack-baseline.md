...
| Date | 15-09-2026 |
| Owner / author / internal reviewer | Principal Product Author / Principal Product Author / independent technology/architecture review `NOT-RUN` |
...
| Final controlled source set | `IE-STD-TECH-STACK-001@0.1`, `IE-KNW-TECH-DEC-001@0.6`, `TECH-001@0.14`, DOC-07@0.11 routing, `IE-ARC-TECH-VIEW-001@0.2`, `IE-VEV-TECH-VIEW-002@0.1` |
...
| Correction record | [`IE-CHG-TECH-VIEW-CORR-001@0.1`](CHG-2026-09-15-technology-architecture-view-correction.md); corrects Worker and reopen-view wording only |
| Product normativity | `INFORMATIVE`; no FTR/REQ/product behavior created or changed |
| Repository process authority / instruction state | `NOT-APPLICABLE` / `NOT-APPLICABLE` |
| Supersedes / Superseded by | Supersedes `IE-CHG-TECH-BASELINE-001@0.1`, Git blob `1d48bc889b9e7573d32d01cca19c68e6f972ea67`; the broader Client recommendation trace remains historical / `NOT-APPLICABLE` |
...
| Artifact and operations | Private server-managed filesystem Adapter; Windows Format Worker boundary and exact CAD/Office/Format Adapter profile contract `SELECT`; deploy/use it only when the exact processing profile requires it; concrete profile values and exact Worker runtime/toolchain qualification `NOT-RUN`; signed/versioned JAR bundle + systemd + host Temurin + company-approved Nginx; telemetry and coordinated recovery baseline |
...
| Technology view set | no predecessor | `IE-ARC-TECH-VIEW-001@0.1`; presentation correction `@0.2` | Add eight focused, traceable diagrams without changing architecture authority; correct only the Worker build meaning and reopen-path presentation in `@0.2`. |
...
## 6. Draft correction history

| Version | Date | Correction | Impact boundary |
|---|---|---|---|
| `0.2` | 2026-09-15 | Replace “conditional Windows Format Worker” with the controlled distinction between a selected Worker boundary, condition-driven deployment/use and an unqualified exact runtime/toolchain; route the corrected technology views. | No stack, Q-15, Product Scope, PDA, PG3 or PG4 change; see `IE-CHG-TECH-VIEW-CORR-001@0.1`. |
| `0.1` | 2026-09-15 | Initial Core v0 Engineering baseline record. | Historical baseline selection retained. |
