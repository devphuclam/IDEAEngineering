...
| SQL Server 2025 | GA Nov 18 2025; mainstream support ends Jan 7 2031 and extended support Jan 7 2036. Linux release notes list SQL Server 2025 CU8 GDR build `17.0.4085.5` on 2026-09-08. Express has the lesser of 1 socket or 4 cores, a 1,410 MB buffer pool and a **50 GB maximum relational database size**; Standard/Enterprise features differ materially ([lifecycle](https://learn.microsoft.com/en-us/lifecycle/products/sql-server-2025), [What's new](https://learn.microsoft.com/en-us/sql/sql-server/what-s-new-in-sql-server-2025?view=sql-server-ver17), [editions/components](https://learn.microsoft.com/en-us/sql/sql-server/editions-and-components-of-sql-server-2025?view=sql-server-ver17), [compute limits](https://learn.microsoft.com/en-us/sql/sql-server/compute-capacity-limits-by-edition-of-sql-server?view=sql-server-ver17), [Linux releases](https://learn.microsoft.com/en-us/sql/linux/sql-server-linux-release-notes?view=sql-server-ver17)) | `ADVANTAGE` where company SQL Server operations/support already exist; production licensing and edition limits are real trade-offs. The 50 GB figure is an edition ceiling, not automatic file growth or proof that Express fits IDEA's concurrency, recovery or operational needs. DDM use is competitor evidence only. | Qualify license/edition, concurrency and growth, HA, restore, FTS, Linux distro and operator ownership. | `NOT-RUN`; finalist |
| React / TypeScript / Vite | React `19.3.0` is current stable (2026-09-09); TypeScript `7.0` is the current stable compiler (stable release announced 2026-07-08; latest listed patch `7.0.2` on 2026-08-20). TypeScript 7 has no stable programmatic compiler API yet, so compiler-API consumers and embedded-language tools may need the TypeScript 6 compatibility line while CLI/type-checking adoption is evaluated. Vite `8.3` is the current patch line and its supported Node ranges include Node.js 24 ([React versions](https://react.dev/versions), [React 19.3](https://react.dev/blog/2026/09/09/react-19-3), [TypeScript 7 announcement](https://devblogs.microsoft.com/typescript/announcing-typescript-7-0/), [TypeScript releases](https://github.com/microsoft/TypeScript/releases), [Vite releases](https://vite.dev/releases), [Vite 8](https://vite.dev/blog/announcing-vite8)) | React + TypeScript + Vite is a valid client-only CSR candidate behind a separate IDEA Server. React framework guidance does not automatically require SSR/RSC; TypeScript 7 is a current fact, not a stack selection. | Qualify Router mode, accessibility/localization, cache invalidation, code splitting, security headers, bundle patching and every compiler-API/plugin dependency. | `NOT-RUN` |
| Windows App SDK / WinUI 3 | Stable Windows App SDK `2.4.0` released 2026-08-13; it is the latest patch in the `2.0` servicing family, which ends 2027-04-29; the `1.8` maintenance window ended 2026-09-09 ([2.0 release notes](https://learn.microsoft.com/en-us/windows/apps/windows-app-sdk/release-notes/windows-app-sdk-2-0), [channels](https://learn.microsoft.com/en-us/windows/apps/windows-app-sdk/release-channels)) | Microsoft guidance recommending WinUI 3 for new native Windows applications is vendor guidance, not proof of lower IDEA lifecycle risk than WPF. | Qualify packaging, no-admin policy, scaling/accessibility, update rollback and the separate App SDK clock. | `NOT-RUN` |
...
Express is free but has the documented lesser-of-1-socket-or-4-core, 1,410 MB buffer-pool and 50 GB
maximum relational database limits. The 50 GB value is an edition ceiling; it does not automatically
resize existing files or remove concurrency, growth, recovery, HA, operations or licensing gates.
Standard and Enterprise have materially different Always On availability-group features; Express has
no equivalent HA feature. Developer is for development/test, not production
([What's new](https://learn.microsoft.com/en-us/sql/sql-server/what-s-new-in-sql-server-2025?view=sql-server-ver17),
[editions/components](https://learn.microsoft.com/en-us/sql/sql-server/editions-and-components-of-sql-server-2025?view=sql-server-ver17),
[compute limits](https://learn.microsoft.com/en-us/sql/sql-server/compute-capacity-limits-by-edition-of-sql-server?view=sql-server-ver17)).
...
- [SQL Server 2025 lifecycle](https://learn.microsoft.com/en-us/lifecycle/products/sql-server-2025), [What's new](https://learn.microsoft.com/en-us/sql/sql-server/what-s-new-in-sql-server-2025?view=sql-server-ver17), [editions/components](https://learn.microsoft.com/en-us/sql/sql-server/editions-and-components-of-sql-server-2025?view=sql-server-ver17), [compute capacity limits](https://learn.microsoft.com/en-us/sql/sql-server/compute-capacity-limits-by-edition-of-sql-server?view=sql-server-ver17), [Linux release notes](https://learn.microsoft.com/en-us/sql/linux/sql-server-linux-release-notes?view=sql-server-ver17), [recovery models](https://learn.microsoft.com/en-us/sql/relational-databases/backup-restore/recovery-models-sql-server?view=sql-server-ver17), [Full-Text Search](https://learn.microsoft.com/en-us/sql/relational-databases/search/full-text-search?view=sql-server-ver17).
...
- [React versions](https://react.dev/versions), [React 19.3](https://react.dev/blog/2026/09/09/react-19-3), [TypeScript 7 announcement](https://devblogs.microsoft.com/typescript/announcing-typescript-7-0/), [TypeScript releases](https://github.com/microsoft/TypeScript/releases), [Vite releases](https://vite.dev/releases), [Edge LNA](https://learn.microsoft.com/en-us/deployedge/ms-edge-local-network-access), [Tauri releases](https://v2.tauri.app/release/), [Rust releases](https://blog.rust-lang.org/releases/).
