...
- **`docs/adr/README.md`** — use the index to distinguish IDEA product decisions from inherited template decisions, then read ADRs that touch the area you're about to work in. In multi-context repos, also check `src/<context>/docs/adr/` for context-scoped decisions.
