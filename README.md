...
| Management Word, slides and update instructions | [Report index](docs/reports/README.md) | User-edited copies, the exact reviewed presentation and current update instructions; not competing product specifications |
