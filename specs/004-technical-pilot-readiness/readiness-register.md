...
**Version / status**: `3.1` / Draft; P01 `COMPLETE / PASS`; P04 `COMPLETE / PASS` for the one-developer internal environment; P02, P03 and P05–P07 remain `NOT-RUN`
**Prepared**: 2026-09-19
...
môi trường phát triển nội bộ một người; các work package P02, P03, P05–P07 vẫn `NOT-RUN`.
...
|---|---|---|---|
| Host allocation and network path | [environment-profile.md](environment-profile.md), Sections 1–2 | Authenticated SSH inventory confirms Ubuntu 26.04.1 LTS, current DHCP route, resources and dedicated artifact mount; application endpoints and stable client route remain `NOT-RUN` | D2 remains `OPEN`; P04 is `IN-PROGRESS`; P05/P06 remain `NOT-RUN`; PG4 is blocked if required evidence is absent |
...
| T022 — P04/P05/P06 result review | P04 profile SHA-256 `78D7E8905D6E79CBE2DD16E17631AE693DA39EA5872A24ED21A404A700036BFF`; [P04 review evidence](evidence/P04-ENV-REVIEW-20260924.md), SHA-256 `5B687457E19ADAB2F0B3F595E3D95CC828F1AB838494D3C794A80B9EADEF3CB1`. P05: `test-data-and-verification.md` SHA-256 `5EF6F8D9F31FA62FEFE5E4C8BFDB39058E50309F71542ED460AD54756E39E07C`; P06: `recovery-and-security-plan.md` SHA-256 `F9950E46CB39C49EC8D3E584D79B330450799927ED0394EBAE9A4C2D0B87CBA8` | `IN-PROGRESS` | P04 result is recorded separately; Reviewer still records P05 and P06 results. T022 closes after all three package results and evidence hashes are present |
