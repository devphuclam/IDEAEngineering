...
- [x] T023 [US5] Recompute all PH0 source hashes, freeze the reviewed manifest/commit and update `specs/004-technical-pilot-readiness/baseline-manifest.md` plus `readiness-register.md` before the gate review (`P07`, FR-015). Evidence: [T023 freeze record](baseline-manifest.md#62-t023-freeze-record), frozen source commit `a9924f467585354cda8017b0f578954a8af0dfd7`.
